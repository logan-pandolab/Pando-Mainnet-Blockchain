...
import (
	...
	p2pcmn "github.com/pandotoken/pando/p2pl/common"

	"github.com/pandotoken/pando/p2pl/peer"

	"github.com/pandotoken/pando/p2pl"
	"github.com/pandotoken/pando/p2pl/transport"
...
const (
	// pandoP2PProtocolPrefix            = "/pando/1.0.0/"
...
func CreateMessenger(pubKey *crypto.PublicKey, seedPeerMultiAddresses []string,
	...
	if viper.GetString(common.CfgP2PProtocolPrefix) != "" {
		...
		protocolPrefix = "/pando/" + viper.GetString(common.CfgGenesisChainID) + "/" + viper.GetString(common.CfgP2PVersion) + "/"
	}
