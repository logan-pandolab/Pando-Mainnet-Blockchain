...
//
// Example:
// pushd $PANDO_HOME/integration/pandonet/node
// generate_genesis -chainID=pandonet -erc20snapshot=./data/genesis_pando_erc20_snapshot.json -stake_deposit=./data/genesis_stake_deposit.json -genesis=./genesis
//
func main() {
