...
func (t *PandoRPCService) BackupSnapshot(args *BackupSnapshotArgs, result *BackupSnapshotResult) error {
...
func (t *PandoRPCService) BackupChain(args *BackupChainArgs, result *BackupChainResult) error {
	chain := t.chain
...
func (t *PandoRPCService) BackupChainCorrection(args *BackupChainCorrectionArgs, result *BackupChainCorrectionResult) error {
	chain := t.chain
