...
func TestVMCreate(t *testing.T) {
	...
	assert.Equal(int64(1000), account2.Balance.PandoWei.Int64())
	assert.Equal(int64(2000-123), account2.Balance.PTXWei.Int64())

	contractAcc := store.GetAccount(contractAddress)
	assert.NotNil(contractAcc)
	assert.Equal(int64(0), contractAcc.Balance.PandoWei.Int64())
	assert.Equal(int64(123), contractAcc.Balance.PTXWei.Int64())
