...
import (
	...
	cn "github.com/pandotoken/pando/p2p/connection"
	nu "github.com/pandotoken/pando/p2p/netutil"
	p2ptypes "github.com/pandotoken/pando/p2p/types"
...
func TestPeerHandshakeAndCommunication(t *testing.T) {
	...
	messagesAtoB := []string{
		...
		"How's everything?",
		"The Pando blockchain is awesome!",
		"The Pando blockchain is the only end-to-end infrastructure for decentralized video streaming and delivery that provides both technical and economic solutions...This is one of the most exciting new blockchain ventures I have heard about.",
	}
