...
func TestBlockEncoding(t *testing.T) {
	...
	// Should be able to encode/decode blocks before Pando2.0 fork.
	b1 := &Block{}
	...
	// Should be able to encode/decode blocks after Pando2.0 fork.
	b2.Height = common.HeightEnablePando2
	b2raw1, _ = rlp.EncodeToBytes(b2)
	err = rlp.DecodeBytes(b2raw1, tmp)
	require.Nil(err)
	b2raw2, _ = rlp.EncodeToBytes(tmp)
